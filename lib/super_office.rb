...
require 'super_office/params_formatter'
require 'super_office/result'
require 'super_office/endpoints/archive/appointment'
require 'super_office/endpoints/archive/internal_users'
require 'super_office/endpoints/archive/person'
require 'super_office/endpoints/archive/sale'
require 'super_office/endpoints/list/task'
